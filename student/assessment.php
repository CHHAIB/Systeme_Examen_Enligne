            ...
            <div class="page-inner">
                <div class="page-title">
                    ...
                    <div class="page-breadcrumb">
                        <ol class="breadcrumb">
                            ...
                            <li><a href="examinations.php">Examen</a></li>
                ...
                <div id="main-wrapper">
                    <div class="row">
                                    ...
                                    <div class="panel-body">
                                       ...
                                       <form action="pages/submit_assessment.php" method="POST" name="quiz" id="quiz_form" >
											...
											<div role="tabpanel" class="tab-pane active fade in" id="tab'.$qno.'">
                                             <p><b>'.$qno.'.</b> '.$qs.'</p>
											 <p><input type="text" name="an'.$qno.'"  class="form-control" placeholder="Entrer votre réponse" autocomplete="off">
								...
								<br><input onclick="return confirm('Êtes-vous sûr de vouloir soumettre votre évaluation ?')" class="btn btn-success" type="submit" value="Submit Assessment">
											</form>
                                    </div>
                                </div>  
                    </div>
