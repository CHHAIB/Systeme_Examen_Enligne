            ...
            <div class="page-sidebar sidebar">
                <div class="page-sidebar-inner slimscroll">
                        ...
                        <div class="sidebar-profile">
                            <a href="javascript:void(0);" id="profile-menu-link">
                                ...
                                <div class="sidebar-profile-details">
                                    <span><?php echo "$myfname"; ?> <?php echo "$mylname"; ?><br><small>OES Etudian</small></span>
                                </div>
                            </a>
                        </div>
                    </div>
                    <ul class="menu accordion-menu">
                        ...
                        <li><a href="results.php" class="waves-effect waves-button"><span class="menu-icon glyphicon glyphicon-certificate"></span><p>Résultats des examens</p></a></li>
                ...
                <div class="page-title">
                    ...
                    <div class="page-breadcrumb">
                        <ol class="breadcrumb">
                            ...
                            <li class="active">Profil de l'étudiant</li>
                        </ol>
                    </div>
                </div>
                <div id="main-wrapper">
                      <div class="row">
						...
						<div class="row">
						        ...
						        <?php print '<img width="150" src="../assets/qrcode/qr_img.php?d='.$qrcodetxt.'">'; ?>
									...
									<table class="table">
                                        <tbody>
											...
											<tr>
                                                <th scope="row">6</th>
                                                <td colspan="2">Addresse<br><i><?php echo "$myaddress"; ?></i></td>
							...
							<div class="col-md-7">
                                ...
                                <div class="panel panel-white">
                                    <div class="panel-body">
									<h3>Mettre à jour l'image de profil</h3>
			                    <form action="pages/new_dp.php" method="POST" enctype="multipart/form-data">
								<div class="form-group">
                                <label for="exampleInputEmail1">Sélectionner l'image à télécharger</label>
...
Télécharger</button>
                                ...
                                <div class="panel panel-white">
                                    <div class="panel-body">
									<h3>Mettre à jour le mot de passe de connexion</h3>
			                    <form action="pages/new_pw.php" method="POST">
								<div class="form-group">
                                <label for="exampleInputEmail1">Entrer un nouveau mot de passe</label>
                                <input type="password" id="password" class="form-control" name="pass1" required placeholder="Entrer un nouveau mot de passe">
                                </div>
