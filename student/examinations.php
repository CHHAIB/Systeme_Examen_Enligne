                                    ...
                                    <div class="panel-body">
                                        ...
                                        <tbody>';
                                           ...
                                           while($row = $result->fetch_assoc()) {
											   ...
											   $stl = '<a class="btn btn-success" href="take-assessment.php?id='.$row['exam_id'].'">Passer Examen</a>';
											   }else{
											   $st = '<p class="text-danger">Inactif</p>'; 
                                               $stl = '<a class="btn btn-danger disabled" href="#">Passer Examen</a>';											   
											   }
                                          print '
										       <tr>
                                                <td>'.$row['exam_name'].'</td>
                                        ...
                                        Rien n`a été trouvé dans la base de données.
                                    </div>';
