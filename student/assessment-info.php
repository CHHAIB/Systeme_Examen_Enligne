        ...
        <main class="page-content content-wrap">
            ...
            <div class="page-sidebar sidebar">
                <div class="page-sidebar-inner slimscroll">
                    ...
                    <ul class="menu accordion-menu">
                        ...
                        <li><a href="results.php" class="waves-effect waves-button"><span class="menu-icon glyphicon glyphicon-certificate"></span><p>Resultats Examen</p></a></li>
            ...
            <div class="page-inner">
                <div class="page-title">
                    <h3>Résultat d'examen</h3>
                    <div class="page-breadcrumb">
                        <ol class="breadcrumb">
                            <li><a href="examinations.php">Résultat </a></li>
                        ...
                        <div class="col-md-6">
                           ...
                           <div class="panel panel-white">
                                <div class="panel-heading">
                                    <h4 class="panel-title">Information sur la résultat</h4>
                                </div>
                           ...
                           <div class="col-md-6">
                            <div class="panel panel-white">
                                ...
                                <div class="alert alert-success" role="alert">
                                       Bien fait! Vous avez réussi cet examen
                                    </div>';								
								}else{
																print '
                                <div class="alert alert-danger" role="alert">
                                    Vous navez pas réussi cet examen.
                                    </div>';		
