...
<head>
        ...
        <title>OES | Passer L'examen</title>
        ...
        <main class="page-content content-wrap">
            ...
            <div class="page-sidebar sidebar">
                <div class="page-sidebar-inner slimscroll">
                        ...
                        <div class="sidebar-profile">
                            <a href="javascript:void(0);" id="profile-menu-link">
                                ...
                                <div class="sidebar-profile-details">
                                    <span><?php echo "$myfname"; ?> <?php echo "$mylname"; ?><br><small>OES Etudiant</small></span>
                                </div>
                            </a>
                        </div>
                    </div>
                    <ul class="menu accordion-menu">
                        ...
                        <li><a href="results.php" class="waves-effect waves-button"><span class="menu-icon glyphicon glyphicon-certificate"></span><p>Résultats de examens</p></a></li>
            ...
            <div class="page-inner">
                <div class="page-title">
                    <h3>Passer L'examen</h3>
                    <div class="page-breadcrumb">
                        <ol class="breadcrumb">
                            <li><a href="examinations.php">L'examens</a></li>
                ...
                <div id="main-wrapper">
                    <div class="row col-md-12">
                        <div class="col-md-6">
                           ...
                           <div class="panel panel-white">
                                <div class="panel-heading">
                                    <h4 class="panel-title">Propriétés d'examen</h4>
                                </div>
                           ...
                           <div class="col-md-6">
                            <div class="panel panel-white">
                                <div class="panel-heading">
                                    <h3 class="panel-title">Termes et Conditions</h3>
                                </div>
                                <div class="panel-body">
                                    <?php echo "$terms"; ?>
                                </div>
						...
						<div class="col-md-6">
                            <div class="panel panel-white">
                                <div class="panel-heading">
                                    <h3 class="panel-title">Passer L'examen</h3>
                                </div>
                                <div class="panel-body">
								<?php
								if ($record_found == "1") {
								...
								print '
                                 <div class="alert alert-success" role="alert">
                                  Tu es prét.
									...
									'; ?>
									<a onclick="return confirm('Are you sure you want to begin ?')" class="btn btn-success" href="assessment.php">Passer l'examen</a>
                                ...
                                print '
								<div class="alert alert-warning" role="alert">
                               Vous pourrez repasser cet examen le '.$retake_date.'
                                </div>';
								}								
                                ...
                                tu es pret.
									...
									'; ?>
									<a onclick="return confirm('Êtes-vous sûr de vouloir commencer ?')" class="btn btn-success" href="assessment.php">
Commencer l'examen</a>
						...
						<div class="col-md-6">
                            <div class="panel panel-white">
                                <div class="panel-heading">
                                    <h3 class="panel-title">Historique de l'examen</h3>
                                </div>
                                <div class="panel-body">
                                <?php
								if ($record_found == "1") {
								print '
                                 <div class="alert alert-info" role="alert">
                                  You attend this exam on <strong>'.$take_date.'</strong> , votre note était <strong>'.$score.'%</strong>
                                    </div>';		
