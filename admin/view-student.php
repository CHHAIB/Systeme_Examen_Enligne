...
<head>
        ...
        <title>SEO | Voir L'étudiant</title>
    ...
    <li><a href="results.php" class="waves-effect waves-button"><span class="menu-icon glyphicon glyphicon-certificate"></span><p>Résultats de tests</p></a></li>
            ...
            <div class="page-inner">
                <div class="page-title">
                    <h3>
Voir l'étudiant - <?php echo "$sdfname"; ?> <?php echo "$sdlname"; ?></h3>
</div>
<div id="main-wrapper">
<div class="row">
<div class="col-md-12">
    ...
    <?php print '<img width="150" src="../assets/qrcode/qr_img.php?d='.$qrcodetxt.'">'; ?>
        ...
        <table class="table">
            <tbody>
                <tr>
                    <th scope="row">1</th>
                    <td>Numéro d'inscription de l'étudiant</td>
                ...
                <tr>
                    <th scope="row">6</th>
                    <td colspan="2">Adresse<br><i><?php echo "$sdaddress"; ?></i></td>
...
<div class="col-md-7">
    ...
    <div class="panel panel-white">
        <div class="panel-body">
        <h3><?php echo "$sdfname"; ?> 
ont déjà essayé les examens suivants :</h3>
