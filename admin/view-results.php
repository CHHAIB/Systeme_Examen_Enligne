...
<head>
        ...
        <title>SEO | <?php echo "$exam_name" ?> Résultats</title>
    ...
    <body <?php if ($ms == "1") { print 'onload="myFunction()"'; } ?>  class="page-header-fixed">
        ...
        <div class="menu-wrap">
            <nav class="profile-menu">
                ...
                <?php 
                if ($myavatar == NULL) {
                print' < width="60" src="../assets/images/'.$mygender.'.png" alt="'.$myfname.'">';
                }else{
        ...
        <main class="page-content content-wrap">
            ...
            <div class="page-sidebar sidebar">
                <div class="page-sidebar-inner slimscroll">
                    ...
                    <ul class="menu accordion-menu">
                        ...
                        <li class="active"><a href="results.php" class="waves-effect waves-button"><span class="menu-icon glyphicon glyphicon-certificate"></span><p>Résultats de tests</p></a></li>
            ...
            <div class="page-inner">
                <div class="page-title">
                    <h3><?php echo "$exam_name" ?> Résultats</h3>
  ...
  print '
       <tr>
        ...
        <ul class="dropdown-menu" role="menu">
            ...
            <li><a'; ?> onclick = "return confirm('Réactiver l'examen pour <?php echo $row['student_name']; ?> ?')" <?php print ' href="pages/re-activate.php?rid='.$row['record_id'].'&eid='.$exam_id.'">Réactiver</a></li>
