...
<li>
    ...
    <ul class="nav nav-tabs" role="tablist">
        ...
        <li role="presentation"><a href="#tab6" role="tab" data-toggle="tab">remplir les espaces vides</a></li>
    </ul>
	...
	<option value="" selected disabled>-Sélectionner Examen-</option>
 	<?php
    ...
    print '<option value="'.$row['exam_id'].'">'.$row['exam_name'].'</option>';
	 ...
	 ?>
        ...
        <input type="text" class="form-control" placeholder="Définir la Question" name="question" required autocomplete="off">
        </div>
...
<tbody>
    <tr>
        ...
        <input type="text" class="form-control" placeholder="Définir l'Option 1" name="opt1" required autocomplete="off">
        </div>
		</td>
    ...
    <tr>
        ...
        <input type="text" class="form-control" placeholder="Définir l'Option 2" name="opt2" required autocomplete="off">
        </div>
		</td>
	...
	<tr>
        ...
        <input type="text" class="form-control" placeholder="Définir l'Option 4" name="opt4" required autocomplete="off">
        </div>
		</td>
 ...
 <form action="pages/add_question2.php?type=fib" method="POST">
    ...
    print '<option value="'.$row['exam_id'].'">'.$row['exam_name'].'</option>';
	 ...
	 ?>
        ...
        <input type="text" class="form-control" placeholder="Définir la Réponse" name="answer" required autocomplete="off">
        </div>
