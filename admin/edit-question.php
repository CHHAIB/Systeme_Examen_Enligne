...
<head>
        ...
        <title>SEO | Modifier la question</title>
        <meta charset="utf-8">
        ...
        <span><?php echo "$myfname"; ?> <?php echo "$mylname"; ?><br><small>SEO Administrateur</small></span>
            ...
            <div class="page-inner">
                <div class="page-title">
                    <h3>Modifier les questions : <?php echo "$question_id"; ?></h3>
...
<form action="pages/update_question.php?type=mc" method="POST">
        ...
        <input type="text" class="form-control" value="'.$question.'" placeholder="Question" name="question" required autocomplete="off">
        </div>
		
<table class="table table-bordered">
<thead>
    <tr>
        <th width="100">Nº Option.</th>
        <th>Option</th>
...
<tbody>
    <tr>
        ...
        <input type="text" value="'.$opt1.'" class="form-control" placeholder="Option 1" name="opt1" required autocomplete="off">
        </div>
		</td>
    ...
    <tr>
        ...
        <input type="text" class="form-control" value="'.$opt2.'" placeholder="Option 2" name="opt2" required autocomplete="off">
        </div>
		</td>
    ...
    <tr>
        ...
        <input type="text" class="form-control" value="'.$opt3.'" placeholder="Option 3" name="opt3" required autocomplete="off">
        </div>
		</td>
	...
	<tr>
        ...
        <input type="text" class="form-control" value="'.$opt4.'" placeholder="Option 4" name="opt4" required autocomplete="off">
        </div>
		</td>
...
print '
 <form action="pages/update_question.php?type=fib" method="POST">
		<div class="form-group">
        <label for="exampleInputEmail1">Question</label>
        <input type="text" class="form-control"  value="'.$question.'" placeholder="définir la Question" name="question" required autocomplete="off">
        </div>
		<div class="form-group">
        <label for="exampleInputEmail1">Réponse</label>
        <input type="text" class="form-control"  value="'.$ans.'" placeholder="définir la Réponse" name="answer" required autocomplete="off">
        </div>
 <input type="hidden" name="question_id"  value="'.$question_id.'">
<button type="submit" class="btn btn-primary">Mettre à jour</button>
</form>';									
