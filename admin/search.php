...
<head>
        ...
        <title>SEO | Trouver "<?php echo strtoupper($keyword); ?>"</title>
        ...
        <main class="page-content content-wrap">
            ...
            <div class="page-inner">
                <div class="page-title">
                    <h3>Résultats de recherche pour "<b><?php echo strtoupper($keyword); ?></b>"</h3>
                ...
                <li role="presentation" class="active"><a href="#tab5" role="tab" data-toggle="tab">Etudiants</a></li>
                <li role="presentation"><a href="#tab6" role="tab" data-toggle="tab">Ajouter Etudiants</a></li>										
          ...
          print '
		       <tr>
                ...
                <ul class="dropdown-menu" role="menu">
                    <li>'.$stl.'</li>
					<li><a href="edit-student.php?sid='.$row['user_id'].'">Editar Estudante</a></li>
					<li><a href="view-student.php?sid='.$row['user_id'].'">Voir Etudiant</a></li>
                    <li><a'; ?> onclick = "return confirm('Supprimer <?php echo $row['first_name']; ?> ?')" <?php print ' href="pages/drop_sd.php?id='.$row['user_id'].'">Supprimer Etudiant</a></li>
                </ul>
            </div></td>
...
<div class="form-group">
    ...
    <input type="text" class="form-control" placeholder="Numéro du contact" name="phone" required autocomplete="off">
</div>
<div class="form-group">
    <label for="exampleInputEmail1">Séléctionner Département</label>
    <select class="form-control" name="department" required>
	<option value="" selected disabled>-Séléctionner Département-</option>
	<?php
	include '../database/config.php';
...
<div class="form-group">
    <label for="exampleInputEmail1">Selecionar Catégorie</label>
    <select class="form-control" name="category" required>
	<option value="" selected disabled>-Selecionar Catégorie-</option>
	<?php
	include '../database/config.php';
...
<input type="text" class="form-control date-picker" name="dob" required autocomplete="off" placeholder="Sélectinner une Date de Naissance">
</div>
