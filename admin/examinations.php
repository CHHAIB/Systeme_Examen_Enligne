...
<head>
        ...
        <title>SEO | Gérer les Examens</title>
...
<li class="active"><a href="examinations.php" class="waves-effect waves-button"><span class="menu-icon glyphicon glyphicon-book"></span><p>Examens</p></a></li>
...
<ul class="nav nav-tabs" role="tablist">
    ...
    <li role="presentation" class="active"><a href="#tab5" role="tab" data-toggle="tab">Examens</a></li>
    <li role="presentation"><a href="#tab6" role="tab" data-toggle="tab">Ajouter Examen</a></li>										
...
while($row = $result->fetch_assoc()) {
   ...
   $stl = '<a href="pages/make_ex_in.php?id='.$row['exam_id'].'">rendre inactif</a>';
   }else{
   $st = '<p class="text-danger">Inactif</p>'; 
   $stl = '<a href="pages/make_ex_ac.php?id='.$row['exam_id'].'">rendre actif</a>';											   
   }
print '
   <tr>
    <td>'.$row['exam_name'].'</td>
    ...
    <ul class="dropdown-menu" role="menu">
        <li>'.$stl.'</li>
		<li><a href="edit-exam.php?eid='.$row['exam_id'].'">Modifier l`examen</a></li>
		<li><a href="view-questions.php?eid='.$row['exam_id'].'">Voir les questions</a></li>
		<li><a href="add-questions.php?eid='.$row['exam_id'].'">Ajouter des questions</a></li>
        <li><a'; ?> onclick = "return confirm('Supprimer <?php echo $row['exam_name']; ?> ?')" <?php print ' href="pages/drop_ex.php?id='.$row['exam_id'].'">Supprimer Examen</a></li>
    </ul>
</div></td>
...
<label for="exampleInputEmail1">Nom de Examen</label>
<input type="text" class="form-control" placeholder="Nom de Examen" name="exam" required autocomplete="off">
</div>
<div class="form-group">
<label for="exampleInputEmail1">
Durée de l'examen(minutes)</label>
<input type="number" class="form-control" placeholder="Durée de l'examen" name="duration" required autocomplete="off">
</div>
<div class="form-group">
<label for="exampleInputEmail1">Pourcentage d'approbation (%)</label>
<input type="number" class="form-control" placeholder="
Définir le pourcentage d'approbation" name="passmark" required autocomplete="off">
</div>
<div class="form-group">
<label for="exampleInputEmail1">Repasser l'examen (après avoir terminé l'examen de l'étudiant, définissez combien de jours l'étudiant repassera l'examen)</label>
<input type="number" class="form-control" placeholder="Entrez les jours pour repasser l'examen" name="attempts" required autocomplete="off">
</div>
<div class="form-group">
<label >Date limite</label>
<input type="text" class="form-control date-picker" name="date" required autocomplete="off" placeholder="Sélectinner Date limite">
</div>
<div class="form-group">
<label for="exampleInputEmail1">Sélectinner le module</label>
<select class="form-control" name="subject" required>
<option value="" selected disabled>-Sélectinner le module-</option>
<?php
include '../database/config.php';
...
<div class="form-group">
<label for="exampleInputEmail1">Sélectinner Filière</label>
<select class="form-control" name="category" required>
<option value="" selected disabled>-Sélectinner Filière-</option>
<?php
include '../database/config.php';
...
<textarea style="resize: none;" rows="6" class="form-control" placeholder="
Termes et conditions" name="instructions" required autocomplete="off"></textarea>
</div>
