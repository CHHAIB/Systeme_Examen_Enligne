...
<head>
        ...
        <title>SEO | Gérer Résultats</title>
    ...
    <body <?php if ($ms == "1") { print 'onload="myFunction()"'; } ?>  class="page-header-fixed">
        ...
        <form class="search-form" action="search.php" method="GET">
            <div class="input-group">
                <input type="text" name="keyword" class="form-control search-input" placeholder="Trouver un Etudiant..." required>
            ...
            <div class="page-sidebar sidebar">
                <div class="page-sidebar-inner slimscroll">
                    ...
                    <ul class="menu accordion-menu">
                        ...
                        <li class="active"><a href="results.php" class="waves-effect waves-button"><span class="menu-icon glyphicon glyphicon-certificate"></span><p>Résultats des tests</p></a></li>
...
<tbody>';
   ...
   while($row = $result->fetch_assoc()) {
       $status = $row['status'];
       if ($status == "Active") {
       $st = '<p class="text-success">Avtif</p>';
  ...
  print '
       <tr>
        ...
        <ul class="dropdown-menu" role="menu">
            ...
            <li><a href="view-results.php?eid='.$row['exam_id'].'">Voir Résultats</a></li>
            <li><a href="summary.php?eid='.$row['exam_id'].'">Petit résumé</a></li>
