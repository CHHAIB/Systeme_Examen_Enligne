     ...
     <body <?php if ($ms == "1") { print 'onload="myFunction()"'; } ?>  class="page-header-fixed">
        ...
        <form class="search-form" action="search.php" method="GET">
            <div class="input-group">
                <input type="text" name="keyword" class="form-control search-input" placeholder="
                Trouver un étudiant..." required>
                    ...
                    <div class="sidebar-profile">
                        <a href="javascript:void(0);" id="profile-menu-link">
                            ...
                            <div class="sidebar-profile-details">
                                <span><?php echo "$myfname"; ?> <?php echo "$mylname"; ?><br><small>Administrateur</small></span>
                            </div>
                        </a>
                    </div>
                </div>
                <ul class="menu accordion-menu">
                    <li><a href="./" class="waves-effect waves-button"><span class="menu-icon glyphicon glyphicon-home"></span><p>
                    Tableau de bord </p></a></li>
                    ...
                    <li><a href="subject.php" class="waves-effect waves-button"><span class="menu-icon glyphicon glyphicon glyphicon-file"></span><p>
                    Questions</p></a></li>
                    ...
                    <li><a href="results.php" class="waves-effect waves-button"><span class="menu-icon glyphicon glyphicon-certificate"></span><p>
                    Résultats de tests</p></a></li>
            ...
            <div class="page-title">
                ...
                <div class="page-breadcrumb">
                    <ol class="breadcrumb">
                        ...
                        <li class="active">Profil de ADM</li>
                    </ol>
                </div>
            </div>
            <div id="main-wrapper">
...
<tr>
    ...
    <td>Prénom</td>
    <td>
	<input type="text" value="<?php echo "$myfname"; ?>" class="form-control" name="fname" placeholder="Prénom" required autocomplete="off"> 
	</td>
...
<tr>
    <th scope="row">2</th>
    <td>Nom</td>
    <td><input type="text" value="<?php echo"$mylname"; ?>" class="form-control" name="lname" placeholder="Nom" required autocomplete="off"> </td>
...
<tr>
	...
	<option selected disbaled value="">-Sélectionner un genre-</option>
...
<tr>
    ...
    <td><input type="text" value="<?php echo "$mydob"; ?>"  class="form-control" name="dob" placeholder="dd/mm/aa" required autocomplete="off"> </td>
...
<tr>
    ...
    <td><input type="email" value="<?php echo "$myemail"; ?>"  class="form-control" name="email" placeholder="Adresse E-mail" required autocomplete="off"> </td>
   
</tr>
<tr>
    <th scope="row">8</th>
    <td>Téléphone</td>
    <td><input type="text" value="<?php echo "$myphone"; ?>" class="form-control" name="phone" placeholder="Téléphone" required autocomplete="off"> </td>
   
</tr>
<tr>
<th scope="row"></th>
<td colspan="2"><button type="submit" class="btn btn-primary">Sauvegarder les modifications</button></td>
...
<div class="col-md-7">
    ...
    <div class="panel panel-white">
        <div class="panel-body">
		<h3>Mettre à jour la photo</h3>
    <form action="pages/new_dp.php" method="POST" enctype="multipart/form-data">
	<div class="form-group">
    <label for="exampleInputEmail1">Sélectionner une image</label>
    ...
    print '<a';?> onclick="return confirm('Supprimer l'image ?')" <?php print ' class="btn btn-danger" href="pages/drop_dp.php">Supprimer image</a>'; 
    }
    ...
    <input type="password" id="password" class="form-control" name="pass1" required placeholder="Nouveau mot de passe">
    </div>
	
	<div class="form-group">
    <label for="exampleInputEmail1">Confirmer le nouveau mot de passe</label>
    <input type="password" id="confirm_password" class="form-control" name="pass2" required placeholder="Confirmer le nouveau mot de passe">
    </div>
	<button type="submit" class="btn btn-primary">Mettre à jour me mot de passe</button>
<script>
