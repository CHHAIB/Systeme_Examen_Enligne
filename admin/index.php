...
<head>
        ...
        <title>SEO | Tableau de Bord Admin</title>
...
<a href="javascript:void(0);" id="profile-menu-link">
    ...
    <div class="sidebar-profile-details">
        <span><?php echo "$myfname"; ?> <?php echo "$mylname"; ?><br><small>OES de l'étudiant</small></span>
    </div>
</a>
</div>
</div>
                ...
                <div class="page-title">
                    ...
                    <div class="page-breadcrumb">
                        <ol class="breadcrumb">
                            ...
                            <li class="active">Tableau de bord Admin</li>
                        </ol>
                    </div>
                </div>
<div id="main-wrapper">
            ...
            <div class="panel info-box panel-white">
                <div class="panel-body">
                    <div class="info-box-stats">
                        ...
                        <span class="info-box-title" >Départements</span>
                    </div>
                            ...
                            <div class="panel info-box panel-white">
                                <div class="panel-body">
                                    <div class="info-box-stats">
                                        ...
                                        <span class="info-box-title">Etudiants</span>
                                    </div>
                                    <div class="info-box-icon">
                                        <i class="icon-user"></i>
                                    </div>
                            ...
                            <div class="panel info-box panel-white">
                                <div class="panel-body">
                                    <div class="info-box-stats">
                                        ...
                                        <span class="info-box-title">Examens</span>
                                    </div>
                                    <div class="info-box-icon">
                            ...
                            <div class="panel info-box panel-white">
                                <div class="panel-body">
                                    <div class="info-box-stats">
                                        ...
                                        <span class="info-box-title">Filières <?php echo "$fp $pp"; ?></span>
                                    </div>
                                    <div class="info-box-icon">
                                        <i class="icon-tag"></i>
                                    </div>
                            ...
                            <div class="panel info-box panel-white">
                                <div class="panel-body">
                                    <div class="info-box-stats">
                                        ...
                                        <span class="info-box-title">Remarques</span>
                                    </div>
                                    <div class="info-box-icon">
                                        <i class="icon-list"></i>
                                    </div>
...
var chart = new CanvasJS.Chart("chartContainer", {
  ...
  title: {
    text: "Présentation par parties des évaluations des élèves en réussite et échec"
  },
  data: [{
    type: "pie",
    startAngle: 25,
    ...
    indexLabel: "{label} - {y}",
    dataPoints: [
      { y: <?php echo "$std_pass"; ?>, label: "Étudiants approuvés" },
      { y: <?php echo "$std_fails"; ?>, label: "Élèves en échec" }
