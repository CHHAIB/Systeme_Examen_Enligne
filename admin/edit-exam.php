...
<head>
        ...
        <title>SEO | Modifier l'examen</title>
        ...
        <div class="menu-wrap">
            <nav class="profile-menu">
                ...
                <div class="profile-menu-list">
                    ...
                    <a href="logout.php"><i class="fa fa-sign-out"></i><span>Se déconncter</span></a>
                </div>
            </nav>
...
<div class="sidebar-profile-details">
    <span><?php echo "$myfname"; ?> <?php echo "$mylname"; ?><br><small>SEO Administrador</small></span>
</div>
</a>
</div>
</div>
            ...
            <div class="page-inner">
                <div class="page-title">
                    <h3>Modifier l'examen- <?php echo "$exname"; ?></h3>
...
<div class="form-group">
    <label for="exampleInputEmail1">Nom de l'xamen</label>
    <input type="text" class="form-control" value="<?php echo"$exname"; ?>" placeholder="Nome de Exame" name="exam" required autocomplete="off">
</div>
<div class="form-group">
    <label for="exampleInputEmail1">Durée de l'examen
 (minutes)</label>
    <input type="number" class="form-control" value="<?php echo"$exduration"; ?>" placeholder="Durée de l'examen
" name="duration" required autocomplete="off">
</div>
<div class="form-group">
    <label for="exampleInputEmail1">Pourcentage (%)</label>
    <input type="number" class="form-control" value="<?php echo"$expassmark"; ?>" placeholder="Pourcentage " name="passmark" required autocomplete="off">
</div>
<div class="form-group">
    <label for="exampleInputEmail1">
Repasser l'examen (après avoir terminé l'examen de l'étudiant, définissez combien de jours l'étudiant repassera l'examen)</label>
    <input type="number" class="form-control" value="<?php echo"$exreex"; ?>" placeholder="
Entrer les jours pour repasser l'examen" name="attempts" required autocomplete="off">
</div>
<div class="form-group">
<label >Date Limite</label>
<input type="text" class="form-control date-picker" value="<?php echo"$exdate"; ?>" name="date" required autocomplete="off" placeholder="Sélectinner une date limite">
</div>
<div class="form-group">
    <label for="exampleInputEmail1">choisir le sujet
</label>
    <select class="form-control" name="subject" required>
	<option value="" selected disabled>-choisir le sujet
-</option>
	<?php
	include '../database/config.php';
...
Termes et conditions
" name="instructions" required autocomplete="off"><?php echo"$exterms"; ?></textarea>
</div>
