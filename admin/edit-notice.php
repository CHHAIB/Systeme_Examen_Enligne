...
<head>
        ...
        <main class="page-content content-wrap">
            ...
            <div class="page-sidebar sidebar">
                <div class="page-sidebar-inner slimscroll">
                    ...
                    <ul class="menu accordion-menu">
                        ...
                        <li><a href="results.php" class="waves-effect waves-button"><span class="menu-icon glyphicon glyphicon-certificate"></span><p>Resultats de tests</p></a></li>
            ...
            <div class="page-inner">
                <div class="page-title">
                    <h3>Ajouter remarque - <?php echo "$title"; ?></h3>
    ...
    <div class="form-group">
        ...
        <input type="text" value="<?php echo "$title"; ?>" class="form-control" placeholder="Titre de remarque" name="title" required autocomplete="off">
    </div>
	
	<div class="form-group">
        <label for="exampleInputEmail1">Description</label>
        <textarea style="resize: none;" rows="4"  class="form-control" placeholder="Définir la description de la remarque" name="Description" required autocomplete="off"><?php echo "$post"; ?></textarea>
    </div>
