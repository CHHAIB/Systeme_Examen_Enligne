...
<head>
        ...
        <title>SEO | Gérer les filières </title>
            ...
            <div class="page-sidebar sidebar">
                <div class="page-sidebar-inner slimscroll">
                    ...
                    <ul class="menu accordion-menu">
                        ...
                        <li class="active"><a href="categories.php" class="waves-effect waves-button"><span class="menu-icon glyphicon glyphicon glyphicon-tags"></span><p>Filières </p></a></li>
                        <li><a href="subject.php" class="waves-effect waves-button"><span class="menu-icon glyphicon glyphicon glyphicon-file"></span><p><p>Modules</p></p></a></li>
...
<ul class="nav nav-tabs" role="tablist">
    <li role="presentation" class="active"><a href="#tab5" role="tab" data-toggle="tab">Filières </a></li>
    <li role="presentation"><a href="#tab6" role="tab" data-toggle="tab">Ajouter des filières </a></li>
</ul>
...
while($row = $result->fetch_assoc()) {
   ...
   $stl = '<a href="pages/make_ct_in.php?id='.$row['category_id'].'">rendre inactif</a>';
   }else{
   $st = '<p class="text-danger">Inactif</p>'; 
   $stl = '<a href="pages/make_ct_ac.php?id='.$row['category_id'].'">rendre actif</a>';											   
    }
    print '
    <tr>
    <td>'.$row['name'].'</td>
    ...
    <ul class="dropdown-menu" role="menu">
        <li>'.$stl.'</li>
        <li><a'; ?> onclick = "return confirm('Supprimer <?php echo $row['name']; ?> ?')" <?php print ' href="pages/drop_ct.php?id='.$row['category_id'].'">Supprimer la filière</a></li>
    </ul>
    </div></td>
   ...
   Rien na été trouvé dans la base de données.
    ...
    <div class="form-group">
        <label for="exampleInputEmail1">Nom Filière</label>
        <input type="text" class="form-control" placeholder="Définir le nom de la filière" name="category" required autocomplete="off">
    </div>
	<div class="form-group">
