...
<head>
        ...
        <title>SEO | Modifier l'étudiant</title>
    ...
    <h3>Modifier l'étudiant - <?php echo "$sdfname"; ?> <?php echo "$sdlname"; ?></h3>
    ...
    <input type="text" value="<?php echo "$sdfname"; ?>" class="form-control" placeholder="Enter Prénom du l'étudiant" name="fname" required autocomplete="off">
    </div>
    <div class="form-group">
    <label for="exampleInputEmail1">Nom</label>
    <input type="text" value="<?php echo "$sdlname"; ?>" class="form-control" placeholder="Enter Nom du l'étudiant" name="lname" required autocomplete="off">
    </div>
    <div class="form-group">
    ...
    <input type="email" value="<?php echo "$sdemail"; ?>" class="form-control" placeholder=" Adresse e-mail" name="email" required autocomplete="off">
    </div>
    <div class="form-group">
    <label for="exampleInputEmail1">Téléphone</label>
    <input type="text" value="<?php echo "$sdphone"; ?>" class="form-control" placeholder="
Numéro du contact" name="phone" required autocomplete="off">
    </div>
    <div class="form-group">
    ...
    <input value="<?php echo "$sddob"; ?>" type="text" class="form-control date-picker" name="dob" required autocomplete="off" placeholder="Sélectinner Date de Naissance">
    </div>

    <div class="form-group">
    <label for="exampleInputEmail1">Adresse</label>
    <textarea style="resize: none;" rows="4" class="form-control" placeholder="Adresse" name="address" required autocomplete="off"><?php echo "$sdaddress"; ?></textarea>
</div>
<input type="hidden" name="student_id" value="<?php echo "$student_id"; ?>">

<button type="submit" class="btn btn-primary">
Mettre à jour <?php echo "$sdfname"; ?></button>
</form>
</div>
</div>  
