...
<head>
        ...
        <title>SEO | Gérer les modeles</title>
            ...
            <div class="page-sidebar sidebar">
                <div class="page-sidebar-inner slimscroll">
                    ...
                    <ul class="menu accordion-menu">
                        ...
                        <li class="active"><a href="subject.php" class="waves-effect waves-button"><span class="menu-icon glyphicon glyphicon glyphicon-file"></span><p>Modules</p></a></li>
                        ...
                        <li><a href="results.php" class="waves-effect waves-button"><span class="menu-icon glyphicon glyphicon-certificate"></span><p>Résultats de test</p></a></li>
                        <li><a href="school.php" class="waves-effect waves-button"><span class="menu-icon glyphicon glyphicon-flag"></span><p>Informations sur l'école</p></a></li>
...
<ul class="nav nav-tabs" role="tablist">
    ...
    <li role="presentation" class="active"><a href="#tab5" role="tab" data-toggle="tab">Modules</a></li>
    <li role="presentation"><a href="#tab6" role="tab" data-toggle="tab">Ajouter un module</a></li>										
...
while($row = $result->fetch_assoc()) {
   ...
   $stl = '<a href="pages/make_sb_in.php?id='.$row['subject_id'].'">rendre inactif</a>';
   }else{
   $st = '<p class="text-danger">Inactif</p>'; 
   $stl = '<a href="pages/make_sb_ac.php?id='.$row['subject_id'].'">rendre actif</a>';											   
   }
print '
   <tr>
    <td>'.$row['name'].'</td>
    ...
    <ul class="dropdown-menu" role="menu">
        <li>'.$stl.'</li>
        <li><a'; ?> onclick = "return confirm('Supprimer <?php echo $row['name']; ?> ?')" <?php print ' href="pages/drop_sb.php?id='.$row['subject_id'].'">Supprimer le module</a></li>
    </ul>
</div></td>
...
Sélectionner le département</label>
<select class="form-control" name="department" required>
<option value="" selected disabled>-
Sélectionner le département-</option>
<?php
include '../database/config.php';
...
<div class="form-group">
<label for="exampleInputEmail1">
Choisir une filière</label>
<select class="form-control" name="category" required>
<option value="" selected disabled>-
Choisir une filière-</option>
<?php
include '../database/config.php';
...
Définir le nom du module" name="subject" required autocomplete="off">
</div>
